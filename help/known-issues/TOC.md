...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + Aktuella problem i [!DNL Adobe Workfront] {#wf-current}
      + [Hem: Meningar från korrektur visas inte i widgeten Mentions](known-issues-workfront/wf-home-mentions-from-proofs-not-in-widget.md)
      + [Integrering: Slack-meddelanden från Workfront aktiveras inte](known-issues-workfront/wf-integrations-slack-notifications-not-triggering.md)
      + [Godkännanden: Det går inte att godkänna dokument från widgeten Mina godkännanden i Hem](known-issues-workfront/wf-approval-not-work-from-widget.md)
      + [Workfront Planning: Felet&quot;Det gick inte att skicka begäran&quot;](/help/known-issues/known-issues-workfront/wf-planning-error-fail-to-submit-request.md)
      + [Godkännanden: Godkännanden låses automatiskt](known-issues-workfront/wf-approvals-are-locked.md)
      + [Tilldelningar: Det går inte att spara avancerad tilldelningsändring från en rapport](known-issues-workfront/wf-assignments-cannot-save-advanced-from-report.md)
      + [Rapportering: Workfront planeringsfält visas inte i rapportverktyget för kontrollpaneler på arbetsytan](known-issues-workfront/wf-reporting-canvas-dashboards-no-planning.md)
      + [Användare: Det går inte att ta bort direktrapporter](known-issues-workfront/wf-users-cannot-remove-direct-reports.md)
      + [Begäranden: Det går inte att överföra ett dokument när en begäran fylls i](known-issues-workfront/wf-request-cannot-submit-with-document.md)
      + [Förfrågningar: &quot;Inget ämne&quot; visas i listan över förfrågningar](known-issues-workfront/wf-requests-no-subject.md)
      + [Anpassade formulär: Visningslogiken visas inte korrekt i det begärda formuläret](known-issues-workfront/wf-custom-forms-display-logic-not-triggering.md)
      + [Inloggning: Workfront läses inte in efter inloggning](known-issues-workfront/wf-login-wf-does-not-load.md)
      + [Utjämning av arbetsbelastning: Timmar per användare har inte beräknats korrekt](known-issues-workfront/wf-workload-balancer-hours-per-user-not-correct.md)
      + [Dokument: Panelen Sammanfattning är tom](known-issues-workfront/wf-documents-summary-panel-is-blank.md)
      + [Begäranden: Felet&quot;Du har inte tillräcklig åtkomst&quot; vid kopiering av begäranden](known-issues-workfront/wf-requests-do-not-have-sufficient-access.md)
      + [Scheman: Det går inte att se undantag från tidigare år](known-issues-workfront/wf-schedules-cannot-see-previous-year-exceptions.md)
      + [Förfrågningar: vyn &quot;Alla&quot; visar inte alla begäranden](known-issues-workfront/wf-requests-not-showing-all.md)
      + [Anpassade formulär: Beräknade fält visar inte data för icke-administratörer](known-issues-workfront/wf-custom-forms-calculated-fields-admin-only.md)
      + [Begäranden: Utkast som skapats tillsammans med begäran orsakar problem](known-issues-workfront/wf-requests-draft-created-with-request.md)
      + [Begäranden: Felet&quot;Du måste vara systemadministratör&quot; när begäranden kopieras](known-issues-workfront/wf-requests-error-when-copying.md)
      + [Användare: Användare har inte etablerats korrekt på Adobe Admin Console](known-issues-workfront/wf-users-on-other-consoles-not-provisioning.md)
      + [Begäranden: Problem med utkast i den nya begärande upplevelsen](known-issues-workfront/wf-requests-issues-with-drafts.md)
      + [Begäranden: Begärandeköer visas flera gånger](known-issues-workfront/wf-requests-queues-duplicated.md)
      + [Användare: Det går inte att uppdatera användaråtkomst](known-issues-workfront/wf-users-no-access-to-view-finance-when-changing-access.md)
      + [Rapporter: Data Lake-frågan returnerar inte förväntade resultat](known-issues-workfront/wf-reports-data-lake-not-return-expected-results.md)
      + [Rapportering: Användare kan se ekonomiska data i Canvas Dashboard-visualiseringar](known-issues-workfront/wf-reporting-users-can-see-financial-data.md)
      + [Workfront Planning: Det går inte att lägga till ett fält i en vy](known-issues-workfront/wf-planning-cannot-add-field.md)
      + [Godkännanden: Widgeten Mina godkännanden visar slutförda godkännanden](known-issues-workfront/wf-approvals-widget-shows-approved-documents.md)
      + [Workfront Planning: Fel vid borttagning av anslutet fält](known-issues-workfront/wf-planning-cannot-delete-connected-field.md)
      + [Användare: Alternativ för att automatiskt generera korrektur saknas i användarprofilen](known-issues-workfront/wf-users-no-option-to-automatically-generate-proofs.md)
      + [Anpassade formulär: Det går inte att redigera RTF-fält](known-issues-workfront/wf-custom-forms-cannot-edit-rich-text-field.md)
      + [Användare: Fel vid öppning av sidan Användare](known-issues-workfront/wf-users-cannot-open-user-tab.md)
      + [Uppgifter: Det går inte att välja användarroll när en uppgift skapas](known-issues-workfront/wf-tasks-cannot-assign-user-role.md)
      + [Korrektur: Korrekturstatusändringar är fördröjda](known-issues-workfront/wf-proof-status-sync-delayed.md)
      + [Uppgifter: Inline-redigering av en uppgift sparas inte](known-issues-workfront/wf-tasks-inline-changes-not-saving.md)
      + [Användare: Gruppredigeringsanvändare tar bort resurspooler och direktrapporter](known-issues-workfront/wf-users-bulk-editing-clears-resource-pools.md)
      + [Begäranden: Det går inte att överföra dokument till begäran från GDrive](known-issues-workfront/wf-requests-cannot-upload-from-gdrive.md)
      + [Uppgifter: Ändringar i avsnittet Uppdrag i en uppgift sparas inte](known-issues-workfront/wf-tasks-assignments-changes-not-saved.md)
      + [Användare: Problem med ändringar i korrekturprofilen](known-issues-workfront/wf-users-proof-profile-changes-not-retained.md)
      + [Begäranden: Behörigheter ärvs inte när en begäran skapas](known-issues-workfront/wf-requests-permissions-not-inherited.md)
      + [Scheman: Tillstånd att schemalägga återkallade för en grupp](known-issues-workfront/wf-schedules-group-permissions-revoked.md)
      + [Uppdrag: Teamtilldelningar sparas inte](known-issues-workfront/wf-assignments-not-saved.md)
      + [Uppgifter: Planerade timmar som inte sparats när uppgiften skapades](known-issues-workfront/wf-tasks-planned-hours-not-saving.md)
      + [Tidrapporter: Tidrapporter har inte genererats](known-issues-workfront/wf-timesheets-not-generated.md)
      + [Uppgifter: Meddelandet&quot;Otillräcklig åtkomst&quot; när redigeringsåtgärder infogas](known-issues-workfront/wf-tasks-insufficent-access-to-edit.md)
      + [Godkännanden: Länkar till godkännanden är inte tillgängliga](known-issues-workfront/wf-approvals-link-not-appearing.md)
      + [Begäranden: Formulärskaparen har inte åtkomst till formuläret](/help/known-issues/known-issues-workfront/wf-requests-creator-does-not-have-access-to-form.md)
      + [Användare: Det går bara att söka efter jobbroller med första ord](known-issues-workfront/wf-users-job-role-first-word.md)
      + [Rapporter: Problem med listrutor i diagram](known-issues-workfront/wf-reports-dropdown-not-working.md)
      + [Användare: Det går inte att använda avancerade alternativ när användare skapas](/help/known-issues/known-issues-workfront/wf-users-cannot-use-advanced-options.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + Aktuella problem i [!DNL Workfront Proof] {#proof-current}
      + [Workfront Proof: korrektur visas inte i mappar](known-issues-workfront-proof/proof-folders-not-showing-proofs.md)
...
+ [!DNL Adobe Workfront Fusion] {#fusion}
   ...
   + Aktuella problem i [!DNL Workfront Fusion] {#fusion-current}
      + [Workfront Fusion: Huvudfel saknas i AWS-moduler](known-issues-workfront-fusion/fusion-missing-header-aws.md)
      + [Workfront Fusion: Jira Search-modulen returnerar ett fel](known-issues-workfront-fusion/fusion-error-in-jira-search.md)
