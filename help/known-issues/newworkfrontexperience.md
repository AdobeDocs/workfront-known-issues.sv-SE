---
title: Kända fel i ny [!DNL Adobe Workfront] upplevelse
description: Kända fel för den nya  [!DNL Adobe Workfront] upplevelsen har rapporterats
...
Den här sidan innehåller identifierade problem i [!DNL Adobe Workfront].
...
| [Anpassade formulär: Det går inte att redigera RTF-fält](known-issues-workfront/wf-custom-forms-cannot-edit-rich-text-field.md) | 8 december 2025 |
| [Uppgifter: Det går inte att välja användarroll när en uppgift skapas](known-issues-workfront/wf-tasks-cannot-assign-user-role.md) | 8 december 2025 |
| [Uppgifter: Textbundna redigeringar av en uppgift sparas inte](known-issues-workfront/wf-tasks-inline-changes-not-saving.md) | 5 december 2025 |
...
| **Utgåva** | **Senast ändrad** |
| ---------------------------------- | ----------------- |
| [Användare: Problem med ändringar i korrekturprofilen](known-issues-workfront/wf-users-proof-profile-changes-not-retained.md) | 12 december 2025 |
| [Tidrapporter: Tidrapporter har inte genererats](known-issues-workfront/wf-timesheets-not-generated.md) | 11 december 2025 |
| [Användare: Det saknas ett alternativ för att automatiskt generera korrektur i användarprofilen](known-issues-workfront/wf-users-no-option-to-automatically-generate-proofs.md) | 10 december 2025 |
| [Användare: Fel vid öppning av sidan Användare](known-issues-workfront/wf-users-cannot-open-user-tab.md) | 8 december 2025 |
| [Korrektur: Korrekturstatusändringar är fördröjda](known-issues-workfront/wf-proof-status-sync-delayed.md) | 8 december 2025 |
| [Begäranden: Det går inte att överföra dokument till begäran från GDrive](known-issues-workfront/wf-requests-cannot-upload-from-gdrive.md) | 2 december 2025 |
| [Uppgifter: Ändringar i avsnittet Uppdrag i en uppgift sparas inte](known-issues-workfront/wf-tasks-assignments-changes-not-saved.md) | 1 december 2025 |
| [Begäranden: Behörigheter ärvs inte när en begäran skapas](known-issues-workfront/wf-requests-permissions-not-inherited.md) | 25 november 2025 |
| [Uppdrag: Grupptilldelningar sparas inte](known-issues-workfront/wf-assignments-not-saved.md) | 25 november 2025 |
| [Scheman: Behörigheter att schemalägga återkallade för en grupp](known-issues-workfront/wf-schedules-group-permissions-revoked.md) | 25 november 2025 |
| [Godkännanden: Länkar till godkännanden är inte tillgängliga](known-issues-workfront/wf-approvals-link-not-appearing.md) | 13 november 2025 |
...
| [Instrumentpanel: Stor tom marginal vid utskrift av instrumentpanel till PDF](known-issues-workfront/inactive/wf-dashboard-blank-area-when-printing.md) | 7 november 2023 |
...
| [Anpassade formulär: Egna formulär för flera objekt kräver [!UICONTROL Manage] eller [!UICONTROL Edit] åtkomst till redigeringsfält](known-issues-workfront/inactive/wf-custom-form-stuck-in-manage-edit-access.md) | 21 november 2022 |
...
| [Projekt: Sena villkor används inte som förväntat](/help/known-issues/known-issues-workfront/wf-projects-late-condition-not-applying.md) | 20 januari 2025 |
| [Anpassade formulär: Företag som saknas i det anpassade typsnittsfältet](/help/known-issues/known-issues-workfront/wf-custom-forms-companies-missing-typeahead.md) | 20 februari 2025 |
...
| [E-postmeddelanden: Användaren har inte omdirigerats till kommentarstråden](known-issues-workfront/inactive/wf-email-notif-user-not-directed-to-thread.md) | 23 april 2021 |
| [Kalendrar: [!DNL OR] filterinstruktion exklusive filterregel](known-issues-workfront/inactive/wf-calendars-or-filter-statement.md) | 23 april 2021 |
| [[!UICONTROL Workfront Proof]: [!UICONTROL Proof Approval]-rapporten kan inte fastställa deadlines korrekt](known-issues-workfront-proof/proof-approval-report-cant-accurately-determine-deadlines.md) | 21 april 2021 |
